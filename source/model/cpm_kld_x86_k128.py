...
from source.embedding.miniPcm import MiniPcmEmbedding as Embedding
...
class Trainer:
    ...
    hyperParams = HyperParams(features=2304, expandBy=86, activate=128, relevant=16)
    trainParams = TrainParams(batchSize=512, numEpochs=128, learnRate=3e-4)
